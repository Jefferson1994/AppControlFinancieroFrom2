...
navItems = [
  ...
  // 3. Colaboradores
  {
    ...
    subItems: [
        { name: 'Listar Colaboradores', view: 'listar_colaboradores' },
  ...
  // 4. Productos
  {
    ...
    subItems: [
        { name: 'Inventario de Productos', view: 'inventario_productos' },
  ...
  // 5. Servicios
  {
    ...
    subItems: [
        { name: 'Catálogo de Servicios', view: 'catalogo_servicios' },
